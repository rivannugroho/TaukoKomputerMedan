...
<head>
    <title>Tauko Komputer Medan</title>
    <meta charset="utf-8">
...
<body class="goto-here">
    <div class="py-1 bg-primary" style=" background-color: #27374D" >
        <div class="container">
                ...
                <div class="col-lg-12 d-block">
                    <div class="row d-flex">
                        <div class="col-md pr-4 d-flex topper align-items-center">
                            ...
                            <a href="tel:<?= settings('company_profile', 'phone'); ?>"><span class="text">082286544366</span></a>
                        </div>
                        <div class="col-md pr-4 d-flex topper align-items-center">
                            <div class="icon mr-2 d-flex justify-content-center align-items-center"><span class="icon-paper-plane"></span></div>
                            <a href="mailto:<?= settings('company_profile', 'email'); ?>"><span class="text">mhdrivannugroho@gmail.com</span></a>
                        </div>
                        <?php if (empty($this->session->userdata('username')) && $this->session->userdata('access') != 'customer') : ?>
                            <div class="col-md-1 pr-1 d-flex topper align-items-center text-lg-right">
                                <div class="icon mr-2 d-flex justify-content-center align-items-center"><span class="icon-user-plus"></span></div>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
        <div class="container">
            <a class="navbar-brand" href="#">Tauko Komputer Medan</a>
            ...
            <div class="collapse navbar-collapse" id="ftco-nav">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item <?= isset($beranda) ? 'active' : ''; ?>"><a href="<?= base_url(); ?>" class="nav-link">Beranda</a></li>
                    <li class="nav-item <?= isset($publicproduct) ? 'active' : ''; ?>"><a href="<?= base_url('public/product'); ?>" class="nav-link">Produk</a></li>
                    <li class="nav-item <?= isset($publiccategory) ? 'active' : ''; ?>"><a href="<?= base_url('public/category'); ?>" class="nav-link">Kategori</a></li>
                    ...
                    <?php if ($this->session->userdata('username') && $this->session->userdata('access') == 'customer') : ?>
                        <li class="nav-item cta cta-colored"><a href="<?= base_url('cart'); ?>" class="nav-link"><span class="icon-shopping_cart">[<?= count(cartTotal(user()['idusers'])); ?>]</span></a></li>
                    <?php else : ?>
                        <li class="nav-item cta cta-colored"><a href="<?= base_url('cart'); ?>" class="nav-link" id="total"></a></li>
                    <?php endif; ?>
                    <?php if ($this->session->userdata('username') && $this->session->userdata('access') == 'customer') : ?>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" id="dropdown04" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><?= user()['user_fullname']; ?></a>
            ...
            <div class="row mb-5">
                <div class="col-md">
                    <div class="ftco-footer-widget mb-4">
                        <h2 class="ftco-heading-2"><a href="#">Tauko Komputer Medan</a></h2>
                        <p>Produk resmi dan bergaransi resmi</p>
                        <ul class="ftco-footer-social list-unstyled float-md-left float-lft mt-5">
                            <li class="ftco-animate"><a href="<?= settings('social_account', 'twitter'); ?>"><span class="icon-twitter"></span></a></li>
                            <li class="ftco-animate"><a href="<?= settings('social_account', 'facebook'); ?>"><span class="icon-facebook"></span></a></li>
                            <li class="ftco-animate"><a href="<?= settings('social_account', 'instagram'); ?>"><span class="icon-instagram"></span></a></li>
                            <li class="ftco-animate"><a href="<?= settings('social_account', 'youtube'); ?>"><span class="icon-youtube"></span></a></li>
                            <li class="ftco-animate"><a href="<?= settings('company_profile', 'website'); ?>"><span class="icon-globe"></span></a></li>
                        </ul>
                    </div>
                </div>
                <!-- <div class="col-md">
                    ...
                    <div class="ftco-footer-widget mb-4">
                        ...
                        <div class="tagcloud">
                            <?php foreach (produk_kategori() as $pk) : ?>
                                <a href="<?= base_url('category/') . $pk['idcategory'] . '/' . $pk['category_seo']; ?>" class="tag-cloud-link"><?= $pk['category_name']; ?></a>
                            <?php endforeach; ?>
                        </div>
                    </div>
                ...
                <div class="col-md-4">
                    <div class="ftco-footer-widget mb-4">
                        ...
                        <div class="block-23 mb-3">
                            <ul>
                                <li><span class="icon icon-map-marker"></span><span class="text">Jl.Pelajar Timur Gg.kelapa<br>
                                        Kode Pos
                                        20202</span></li>

                                <li><a href="tel:<?= settings('company_profile', 'phone'); ?>"><span class="icon icon-phone"></span><span class="text">082286544366</span></a></li>
                                <li><a href="mailto:<?= settings('company_profile', 'email'); ?>"><span class="icon icon-envelope"></span><span class="text">mhdrivannugroho@gmail.com</span></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
