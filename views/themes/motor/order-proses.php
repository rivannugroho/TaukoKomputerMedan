<div class="hero-wrap hero-bread" style="background-image: url('<?= base_url() . 'views/themes/' . theme_active() . '/'; ?>images/image6.jpg');">
    <div class="container">
    ...
    <div class="container">
        <div class="row block-9 table-responsive" style="overflow:scroll; height:400px;width:100%;">
            <table class="table">
                ...
                <tbody>
                    <?php
                    foreach (orderan(user()['idusers'], 'proses') as $o) : ?>
                        <tr class="text-center">
                            <td><?= $o->code; ?></td>
