...
<section id="home-section" class="hero">
    ...
    <div class="slider-item" style="background-image: url(<?=base_url().'uploads/dashboard10.jpg'; ?>); ">
        <div class="overlay"></div>
      <div class="container">
        <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
          <div class="col-md-12 ftco-animate text-center">
            <h1 class="mb-2">Laptop dengan kualitas terbaik</h1>
            <h2 class="subheading mb-4">Terbaik dikelasnya</h2>
    ...
    <div class="slider-item" style="background-image: url(<?=base_url().'uploads/image3.jpg'; ?>);  ">
        <div class="overlay"></div>
      <div class="container">
        <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
          <div class="col-sm-12 ftco-animate text-center">
            <h1 class="mb-2">Laptop dengan kualitas terbaik</h1>
            <h2 class="subheading mb-4">Barang Resmi</h2>
            <p><a href="<?=base_url('public/product');?>" class="btn btn-danger">Belanja Sekarang</a></p>
          </div>
        </div>
      </div>
    </div>
    <div class="slider-item" style="background-image: url(<?=base_url().'uploads/image2.jpg'; ?>); ">
        <div class="overlay"></div>
      <div class="container">
        <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
          <div class="col-sm-12 ftco-animate text-center">
                ...
                <div class="row">
                    <div class="col-md-4 align-items-stretch d-flex">
                        <div class="category-wrap-2 ftco-animate img align-self-stretch d-flex"
                            style="background-image: url(<?=base_url().'views/themes/'.theme_active().'/';?>images/dashboard7.jpg);">
                            <div class="text text-center">
                                <h2> </h2>
                                <br>
                                <br>
                                <p class="text-white">Silahkan pilih kategori produk yang ada</p>
    ...
    <div class="container">
        <div class="row justify-content-center mb-3 pb-3">
            <div class="col-md-12 heading-section text-center ftco-animate">
                ...
                <p>Silahkan pilih Laptop Anda</p>
            </div>
        </div>
    </div>
    <div class="container">
    ...
    <div class="container">
        <div class="row justify-content-center mb-5 pb-3">
            <div class="col-md-7 heading-section ftco-animate text-center">
                ...
                <p>Berikut ini testimoni pelanggan yang sudah berbelanjang di Tauko Komputer Medan.</p>
            </div>
        </div>
