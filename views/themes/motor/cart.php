    ...
    <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
            <div class="col-md-9 ftco-animate text-center">
                ...
                <h1 class="mb-0 bread">Pengirimam gratis Ongkir Di Seluruh Indonesia </h1>
            </div>
        </div>
    </div>
</div>
                        ...
                        <tbody>
                            ...
                            <tr class="text-center">
                                ...
                                <td class="product-name">
                                    ...
                                    <p>Satuan: <?=$items['satuan'];?><br> Berat: <?php echo is_numeric($items['berat']) && is_numeric($items['qty']) ? $items['berat']*$items['qty'] : 'Invalid value'; ?> gram</p>
                                </td>
                    ...
                    <div class="cart-total mb-3">
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" class="form-control text-left px-3" name="weight"
                                value="<?=cartWeight(user()['idusers']);?>" readonly required>
