...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <a class="text-orange" href="<?= site_url('product?s=minim'); ?>">Stok < 10 (<?= count(produk(null, 10)); ?>) | </a>
                <a href="<?= base_url('product/create'); ?>" class="btn btn-sm btn-primary btn-flat"><i class="fa fa-plus"></i>
                    Add New</a>
            ...
            id="delete_all"><i class="fa fa-recycle"></i></a> -->
                <a href="#" class="btn btn-sm btn-primary btn-flat" data-toggle="tooltip" data-placement="top" title="Delete Permanentelly" id="delete_permanen_all"><i class="fa fa-trash"></i></a>
            ...
            data-placement="top" title="Export Excel"><i class="fa fa-file-excel-o"></i></a> -->
                <a href="<?= base_url('product?s=all'); ?>" class="btn btn-sm btn-primary btn-flat" data-toggle="tooltip" data-placement="top" title="Refresh"><i class="fa fa-refresh"></i></a>
    </ol>
</section>
<!-- Main content -->
                    ...
                    ?>
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="#ganti_gambar" data-toggle="modal" onclick="ubah_gambar(<?= $p['idproduct']; ?>)"><img src="<?= base_url('uploads/products/') . $p['product_image']; ?>" alt="<?= $p['product_image']; ?>" width="60" height="50"></a>
                            </td>
                            ...
                            <?php if (isset($_GET['s']) && $_GET['s'] == 'minim') : ?>
                                <td><?= money($p['stok']); ?></td>
                                <td><a href="#modal_restok" class="btn btn-xs btn-info btn-flat" data-toggle="modal" onclick="view(<?= $p['idproduct']; ?>)">Re-Stok</a>
                                </td>
                            <?php else : ?>
