            ...
            <div class="box-body pad">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <?php if (isset($edata) && is_array($edata)) : ?>
                        ...
                        <input type="text" class="form-control" placeholder="ex : nama produk" name="product_name" value="<?= !empty($edata) ? $edata['product_name'] : set_value('product_name'); ?>" autofocus>
                    </div>
                </div>
                <div class="col-md-6">
                    <!-- Box Add Post -->
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="ex : buah" name="satuan" value="<?= !empty($edata) ? $edata['satuan'] : set_value('satuan'); ?>">
                    </div>
                </div>
                <div class="col-md-6">
                    <!-- Box Add Post -->
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control harga" placeholder="Harga Beli" name="harga_beli" value="<?= !empty($edata) ? $edata['harga_beli'] : set_value('harga_beli'); ?>">
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control harga" placeholder="Harga Jual" name="harga_jual" value="<?= !empty($edata) ? $edata['harga_jual'] : set_value('harga_jual'); ?>">
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control harga" placeholder="Harga Diskon" name="diskon" value="<?= !empty($edata) ? $edata['diskon'] : set_value('diskon'); ?>">
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control harga" placeholder="Berat Produk" name="berat" value="<?= !empty($edata) ? $edata['berat'] : set_value('berat'); ?>">
                            <div class="input-group-addon">
                                gram
                            </div>
                        </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control harga" placeholder="Stok Produk" name="stok" value="<?= !empty($edata) ? $edata['stok'] : set_value('stok'); ?>" <?= $edit_stok; ?>>
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="form-group">
                        <label>Keterangan <span style="color:red;">*</span></label>
                        <textarea id="editor1" name="keterangan" rows="10" cols="80"><?= !empty($edata) ? $edata['keterangan'] : set_value('keterangan'); ?></textarea>
                    </div>
                </div>
                <div class="col-md-12">
                    <!-- Box Add Post -->
                    <div class="form-group">
                        ...
                        <input type="file" class="form-control" name="image" value="<?= !empty($edata) ? $edata['product_image'] : set_value('image'); ?>">
