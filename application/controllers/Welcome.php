...
class Welcome extends CI_Controller
{
	...
	public function order_total()
	{
		...
		$data['orderan_total']=$this->Public_m->totalBeli(user()['idusers']);
	...
	{
		is_logged_in();
		$data['orderan_proses']=$this->Public_m->totalBeli(user()['idusers']);
	...
	{
		is_logged_in();
		$data['orderan_delivered'] = $this->Public_m->totalBeli(user()['idusers']);
